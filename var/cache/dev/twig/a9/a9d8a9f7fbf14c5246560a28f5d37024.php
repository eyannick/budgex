...
class __TwigTemplate_152585c4f407c6078912a7b4578d17ad extends Template
{
    ...
    <div class=\"container\">
        ...
        yield "\" alt=\"...\" style=\"height: 48px\" />
                        ...
                        <!--<?php 
                            // Gestion d'affichage des alertes afin d'avertir l'utilisateur si des modifications ont été prises en compte (géré par la classe Toolbox)
                        ...
                        ";
        // line 64
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["registerForm"]) || array_key_exists("registerForm", $context) ? $context["registerForm"] : (function () { throw new RuntimeError('Variable "registerForm" does not exist.', 64, $this->source); })()), 'form');
        yield "
                    </div>
                </div>
            </div>
...
";
    ...
    {
        return array (  141 => 64,  87 => 13,  76 => 4,  63 => 3,  40 => 1,);
    }
...
{% endblock %}", "register/index.html.twig", "C:\\wamp\\www\\budgex\\templates\\register\\index.html.twig");
    }
}
