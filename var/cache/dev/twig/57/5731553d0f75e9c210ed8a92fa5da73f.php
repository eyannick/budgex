...
<html lang=\"fr\">
    ...
    <body class=\"nav-fixed bg-light\">
        ...
        yield "\"><div class=\"text-uppercase font-monospace\">Budgex</div></a>
                <!-- Navbar items-->
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 57, $this->source); })()), "user", [], "any", false, false, false, 57)) {
            ...
            yield "\">
                                ...
                                <li>
                                    <a class=\"dropdown-item\" href=\"";
            // line 65
            yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_update-password");
            yield "\">
                    ...
                    <div class=\"drawer-footer border-top\">
                        <div class=\"d-flex align-items-center\">
                            ...
                            <div class=\"ms-3\">
                                ...
                                ";
        // line 347
        if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 347, $this->source); })()), "user", [], "any", false, false, false, 347)) {
            // line 348
            yield "                                <div class=\"small fw-500\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 348, $this->source); })()), "user", [], "any", false, false, false, 348), "firstname", [], "any", false, false, false, 348) . " ") . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 348, $this->source); })()), "user", [], "any", false, false, false, 348), "lastname", [], "any", false, false, false, 348)), "html", null, true);
            yield "</div>
                                ";
        } else {
            // line 350
            yield "                                <div class=\"small fw-500\">Utilisateur</div>
                                ";
        }
        // line 352
        yield "                            </div>
...
";
    ...
    {
        return array (  511 => 362,  494 => 388,  467 => 363,  465 => 362,  453 => 352,  449 => 350,  443 => 348,  441 => 347,  188 => 96,  179 => 91,  176 => 90,  167 => 84,  157 => 77,  148 => 71,  139 => 65,  130 => 59,  125 => 57,  117 => 52,  105 => 43,  101 => 42,  93 => 37,  78 => 25,  62 => 12,  49 => 1,);
    }
    ...
    <body class=\"nav-fixed bg-light\">
        ...
        <nav class=\"top-app-bar navbar navbar-expand navbar-dark bg-dark\">
            <div class=\"container-fluid px-4\">
                ...
                <button class=\"btn btn-lg btn-icon order-1 order-lg-0\" id=\"drawerToggle\" href=\"javascript:void(0);\"><i class=\"fas fa-bars\"></i></button>
                <!-- Navbar brand-->
                <a class=\"navbar-brand me-auto\" href=\"{{ path('app_home') }}\"><div class=\"text-uppercase font-monospace\">Budgex</div></a>
                <!-- Navbar items-->
                <div class=\"d-flex align-items-center mx-3 me-lg-0\">
                    <!-- Navbar-->
                    <ul class=\"navbar-nav d-none d-lg-flex\">
                        <li class=\"nav-item\"><a class=\"nav-link\" href=\"{{ path('app_home') }}\">Accueil</a></li> 
                        <li class=\"nav-item\"><a class=\"nav-link\" href=\"{{ path('app_dashboard') }}\">Tableau de bord</a></li>
                    </ul>
                    <!-- Navbar buttons-->
                    <div class=\"d-flex\">
                        <!-- User profile dropdown-->
                        <div class=\"dropdown\">
                            ...
                            <ul class=\"dropdown-menu dropdown-menu-end mt-3\" aria-labelledby=\"dropdownMenuProfile\">
                                ...
                                <li>
                                    <a class=\"dropdown-item\" href=\"{{ path('app_update-password') }}\">
                                        <i class=\"fas fa-solid fa-key leading-icon\"></i>
                                        <div class=\"me-3\">Modifier mot de passe</div>
                                    </a>
                                </li>
                    ...
                    <div class=\"drawer-footer border-top\">
                        <div class=\"d-flex align-items-center\">
                            ...
                            <div class=\"ms-3\">
                                <div class=\"caption\">Utilisateur :</div>
                                {% if app.user %}
                                <div class=\"small fw-500\">{{ \"#{app.user.firstname} #{app.user.lastname}\" }}</div>
                                {% else %}
...
", "base.html.twig", "C:\\wamp64\\www\\budgex\\templates\\base.html.twig");
    }
}
